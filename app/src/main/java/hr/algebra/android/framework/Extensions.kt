package hr.algebra.android.framework
...
import hr.algebra.android.DELAY
...
fun Context.fetchItems() : MutableList<Item> {
    ...
    while (cursor != null && cursor.moveToNext()){
        ...
        items.add(Item(
            ...
            cursor.getString(cursor.getColumnIndexOrThrow(Item::tagline.name)),
            cursor.getString(cursor.getColumnIndexOrThrow(Item::first_brewed.name)),
            cursor.getString(cursor.getColumnIndexOrThrow(Item::description.name)),
            cursor.getString(cursor.getColumnIndexOrThrow(Item::image_url.name)),
            cursor.getString(cursor.getColumnIndexOrThrow(Item::brewers_tips.name)),
            cursor.getString(cursor.getColumnIndexOrThrow(Item::contributed_by.name)),
